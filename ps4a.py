...
def updateHand(hand, word):
    ...
    for letter in word: 
        remainingHand[letter] -= 1
        if remainingHand[letter] == 0:
            del remainingHand[letter]
...
def isValidWord(word, hand, wordList):
    ...
    for letter in word:
        if letter not in hand:
            ...
            copy_of_hand[letter] -= 1
        if copy_of_hand[letter] < 0:
            return False
    return True
    ...
    while x > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print()
                # Update the hand 
                q = updateHand(hand, word)
                hand = q
                x = calculateHandlen(q)
